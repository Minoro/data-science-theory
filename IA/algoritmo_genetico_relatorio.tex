...
Executando o algoritmo dez vezes obteve-se um total de 3936 mochilas com valor igual a melhor solução (contando todas as execuções).
...
Executando o algoritmo dez vezes obteve-se um total de 3936 mochilas com valor igual a melhor solução (contando todas as execuções). A primeira solução foi encontrada na geração 146 e 500.
